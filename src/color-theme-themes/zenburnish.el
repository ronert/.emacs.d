...
(defvar zenburn-bg "#1a1a1a")
(defvar zenburn-border "#121212")
(defvar zenburn-bg+1 "#2a2a2a")
(defvar zenburn-bg+2 "#3a3a3a")
  ...
  (color-theme-install
   (append
    (list 'color-theme-zenburnish
          ...
          '(zenburn-primary-4 ((t (:foreground "#dca3a3"))))
          ...
          '(font-lock-comment
            ((t (:inherit zenburn-green :italic t))))
          ...
          '(org-level-1 ((t (:foreground "#dfaf8f" :height 1.5))))         ;; zenburn-orange
          '(org-level-2 ((t (:foreground "#f0dfaf" :height 1.2))))         ;; zenburn-yellow
          '(org-level-3 ((t (:foreground "#8cd0d3" :height 1.1))))         ;; zenburn-blue
          '(org-level-4 ((t (:foreground "#5f7f5f" :height 1.1))))         ;; zenburn-green-1
          '(org-level-5 ((t (:foreground "#7cb8bb" :height 1.1))))         ;; zenburn-blue-1
          ...
          '(magit-diff-del ((t (:inherit zenburn-red))))
...
(defalias 'zenburnish #'color-theme-zenburnish)
